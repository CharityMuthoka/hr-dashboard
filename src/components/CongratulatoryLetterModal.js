...
export default function CongratulatoryLetterModal({ isOpen, onClose }) {
  const handleSubmit = (e) => {
    ...
    if (form.checkValidity()) {
      ...
      console.log("Generated Congratulatory Letter:", data);
      onClose();
    } else {
      form.reportValidity();
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
      <div className="bg-white w-full max-w-lg max-h-[90vh] rounded-lg shadow-lg p-6 overflow-y-auto relative">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-4 mt-2">
          Generate Congratulatory Letter
        </h2>
     {/*form section */}
        <form id="warning-letter-form" onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            >
              ...
              <option value="performance">Select template</option>
            </select>
          </div>
