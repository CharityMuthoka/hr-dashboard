...
>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
  ...
  <div className="bg-white rounded-lg border border-gray-100 shadow p-4">
    <h2 className="text-md font-semibold text-gray-800 mb-4">KPI Trends by Department</h2>
  ...
  <div className="bg-white rounded-lg border border-gray-100 shadow p-4">
    <h2 className="text-md font-semibold text-gray-800 mb-4">Performance Distribution</h2>
    <div className="flex items-center justify-center">
      
      <img src="/images/performance_distribution.png" alt="training chart" className="w-32 h-32 object-contain" />
    </div>
  </div>
  </div> 
  
  <div className="border rounded-lg mt-3 mb-4 shadow p-6 mt-4">
    <h2 className=" font-semibold text-base text-grey-700 px-2 py-3">Upcoming Appraisals Calendar</h2>
...
<div className=" bg-white p-4 rounded-lg shadow border border-gray-100 transition -transform duration-200 hover:-translate-y-1 hover:shadow-xl">
  ...
  <p className="text-base mt-3" style={{color:'#17ae9e'}}>5</p>
...
<div className=" bg-white p-4 rounded-lg shadow border border-gray-100 transition -transform duration-200 hover:-translate-y-1 hover:shadow-xl">
  ...
  <p className="text-base mt-3" style={{color:'#17ae9e'}}>1</p>
  <h4 className="text-base font-normal text-gray-700">appraisals</h4>
</div>
...
<div className=" bg-white p-4 rounded-lg shadow border border-gray-100 transition -transform duration-200 hover:-translate-y-1 hover:shadow-xl">
  ...
  <p className="text-base mt-3" style={{color:'#17ae9e'}}>2</p>
  <h4 className="text-base font-normal text-gray-700">appraisals</h4>
</div>
...
<div className=" bg-white p-4 rounded-lg shadow border border-gray-100 transition -transform duration-200 hover:-translate-y-1 hover:shadow-xl">
  ...
  <p className="text-base mt-3" style={{color:'#17ae9e'}}>3</p>
  <h4 className="text-base font-normal text-gray-700">appraisals</h4>
</div>
</div>
